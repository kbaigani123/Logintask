...
declare namespace methods {
     ...
     */
    function grantPermissions(this: import("../adb.js").ADB, pkg: string, permissions: string[]): Promise<void>;
    /**
     ...
     */
    function setHiddenApiPolicy(this: import("../adb.js").ADB, value: string | number, ignoreError?: boolean | undefined): Promise<void>;
    /**
     ...
     *                        options.
     */
    function push(this: import("../adb.js").ADB, localPath: string, remotePath: string, opts?: any): Promise<void>;
    /**
