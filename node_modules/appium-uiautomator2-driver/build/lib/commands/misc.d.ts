...
export class suspendChromedriverProxy {
    chromedriver: any;
    proxyReqRes: any;
    proxyCommand: (<TReq = any, TRes = unknown>(url: string, method: import("appium-android-driver/node_modules/@appium/types").HTTPMethod, body?: TReq | undefined) => Promise<TRes>) | undefined;
